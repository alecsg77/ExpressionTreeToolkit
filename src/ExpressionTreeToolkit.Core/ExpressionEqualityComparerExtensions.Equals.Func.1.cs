...
namespace ExpressionTreeToolkit
{
    ...
    {
        /// <summary>Determines whether two <see cref="LambdaExpression"/> are equal.</summary>
        /// <param name="target">An [IEqualityComparer](xref:System.Collections.Generic.IEqualityComparer`1)&lt;<see cref="Expression"/>&gt; used to compare the two <see cref="LambdaExpression"/>.</param>

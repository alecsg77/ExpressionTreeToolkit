...
namespace ExpressionTreeToolkit
{
    ...
    {
        /// <summary>Serves as a hash function for the specified <see cref="LambdaExpression"/> for hashing algorithms and data structures, such as a hash table.</summary>
        /// <param name="target">An [IEqualityComparer](xref:System.Collections.Generic.IEqualityComparer`1)&lt;<see cref="Expression"/>&gt; used to serve the hash function.</param>
        /// <param name="obj">The <see cref="LambdaExpression"/> for which to get a hash code.</param>
